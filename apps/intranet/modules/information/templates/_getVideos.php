...
$(document).ready(function() {
    ...
    $('.deleted-video').click(function(){
        var id  = $(this).attr('id');
        var url = '<?php echo url_for($url_d_videos) ?>';
        var type = $(this).attr('alt');
        
        jQuery.ajax({
        type: 'POST',
        url: url,
        data: 'id_video='+id+'&type='+type,
...
<fieldset>
    ...
    <table width="100%" cellspacing="4" cellpadding="0" border="0">
        ...
        <tr>
            ...
            <td>
                <img src="/images/borrar_hover.png" class="deleted-video" alt="<?php echo $v['type'] ?>" <?php if($v['type'] == 'real'): ?> id="<?php echo $v['id'] ?>" <?php else: ?>  id="<?php echo $k ?>" <?php endif; ?> border="0" width="20" height="20" style="cursor: pointer"/>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
