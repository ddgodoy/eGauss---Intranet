...
/**
 * ReunionContractsIntermediation filter form base class.
 *
 * @package    egauss
 * @subpackage filter
 ...
 */
abstract class BaseReunionContractsIntermediationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reunion_contracts_intermediation_filters[%s]');
