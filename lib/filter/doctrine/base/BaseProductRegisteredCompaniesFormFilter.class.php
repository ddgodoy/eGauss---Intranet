...
/**
 * ProductRegisteredCompanies filter form base class.
 *
 * @package    egauss
 * @subpackage filter
 ...
 */
abstract class BaseProductRegisteredCompaniesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('product_registered_companies_filters[%s]');
