...
abstract class BaseDocumentsRegisteredCompaniesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ci_comments_id'              => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ContractsIntermediationComments'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'ci_comments_id'              => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ContractsIntermediationComments'), 'column' => 'id')),
