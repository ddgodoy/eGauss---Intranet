...
/**
 * AppUserRegisteredCompanies form base class.
 *
 * @method AppUserRegisteredCompanies getObject() Returns the current form's model object
 *
 * @package    egauss
 * @subpackage form
 ...
 */
abstract class BaseAppUserRegisteredCompaniesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('app_user_registered_companies[%s]');
