...
/**
 * ProductsContractsIntermediation form base class.
 *
 * @method ProductsContractsIntermediation getObject() Returns the current form's model object
 *
 * @package    egauss
 * @subpackage form
 ...
 */
abstract class BaseProductsContractsIntermediationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'products_id'                 => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Products'), 'required' => false)),
      ...
      'percentage'                  => new sfValidatorString(array('max_length' => 200, 'required' => false)),
      'created_at'                  => new sfValidatorDateTime(),
      'updated_at'                  => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('products_contracts_intermediation[%s]');
