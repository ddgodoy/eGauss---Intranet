...
/**
 * RegisteredCompaniesContractsIntermediation form base class.
 *
 * @method RegisteredCompaniesContractsIntermediation getObject() Returns the current form's model object
 *
 * @package    egauss
 * @subpackage form
 ...
 */
abstract class BaseRegisteredCompaniesContractsIntermediationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('registered_companies_contracts_intermediation[%s]');
