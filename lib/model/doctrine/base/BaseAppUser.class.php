 ...
 * @property string $contact_time_to
 ...
 * @method AppUser             setTitle()                   Sets the current record's "title" value
 ...
 * @method AppUser             setAppUser()                 Sets the current record's "AppUser" value
 * @method AppUser             setRegisteredCompanies()     Sets the current record's "RegisteredCompanies" value
...
abstract class BaseAppUser extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('contact_time_from', 'string', 50, array(
             'type' => 'string',
             'notnull' => true,
             'length' => 50,
             ));
        $this->hasColumn('contact_time_to', 'string', 50, array(
             'type' => 'string',
             'notnull' => true,
             'length' => 50,
             ));
